  ...
  return (
    <div className="max-w-2xl mx-auto py-12 px-6">
      ...
      <section className="mb-8">
        <h2 className="text-sm font-semibold text-gray-500 uppercase tracking-wide mb-4">Generation Method</h2>
        <div className="bg-white border border-gray-200 rounded-lg shadow-sm divide-y divide-gray-100">
          <label className={`flex items-start gap-4 px-5 py-4 cursor-pointer rounded-t-lg transition-colors ${!cliMode ? 'bg-indigo-50' : 'hover:bg-gray-50'}`}>
            <input
              type="radio"
            ...
            />
            <div>
              <p className="text-sm font-medium text-gray-800">Claude API</p>
              <p className="text-xs text-gray-500 mt-0.5">
                Generate artifacts directly in the app using your Anthropic API key. Requires a separate API account with credits.{' '}
          ...
          <label className={`flex items-start gap-4 px-5 py-4 cursor-pointer rounded-b-lg transition-colors ${cliMode ? 'bg-indigo-50' : 'hover:bg-gray-50'}`}>
            <input
              type="radio"
              name="generation-method"
              checked={cliMode}
            ...
            />
            <div>
              <p className="text-sm font-medium text-gray-800">Claude Code / Pro</p>
              <p className="text-xs text-gray-500 mt-0.5">
